        ...
        <div className="overflow-y-auto pr-1 flex-1 space-y-2 my-2">
          ...
          {needsFightingStyleChoice && (
            <div className="bg-slate-950/90 p-2.5 rounded-lg border border-amber-500/30 space-y-1.5">
              <div className="flex items-center justify-between">
                <h3 className="text-[11px] font-bold text-amber-400 uppercase tracking-wider flex items-center gap-1">
                  <span>⚔️</span> Estilo de Luta (Manter ou Trocar)
                </h3>
                <span className="text-[9px] bg-slate-800 text-slate-300 border border-slate-700 px-1.5 py-0.5 rounded font-medium">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-1">
                {FIGHTING_STYLES.map(fs => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between gap-1">
                        <div className={`font-bold text-[10px] ${isSelected ? 'text-amber-200' : 'text-slate-200'}`}>
                          {fs.name}
                        </div>
                        {fs.disabled ? (
                          <span className="text-[8px] px-1 rounded bg-slate-900 text-amber-400 border border-amber-500/30">
                            🔒
                          </span>
                        ) : isSelected ? (
                          <span className="text-[8px] px-1 rounded bg-amber-400 text-slate-950 font-bold">
